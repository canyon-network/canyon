...
use super::{ChunkFetchingRequest, IsRequest, Protocol};
...
pub type ResponseSender = oneshot::Sender<Result<Vec<u8>, sc_network::RequestFailure>>;
...
pub enum RequestError {
    ...
    #[error("{0}")]
    NetworkError(#[source] sc_network::RequestFailure),
...
async fn receive_response<Req>(
    rec: oneshot::Receiver<Result<Vec<u8>, sc_network::RequestFailure>>,
...
impl From<sc_network::RequestFailure> for RequestError {
    fn from(err: sc_network::RequestFailure) -> Self {
