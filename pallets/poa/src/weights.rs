...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn process_poa_outcome() -> Weight {
        (1_042_952_000 as Weight)
            .saturating_add(T::DbWeight::get().reads(4 as Weight))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
    }
    // Storage: Poa PoaConfig (r:0 w:1)
    fn set_config() -> Weight {
        (16_169_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
}
...
impl WeightInfo for () {
    ...
    // Storage: Poa PoaConfig (r:0 w:1)
    fn set_config() -> Weight {
        (16_169_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
}
